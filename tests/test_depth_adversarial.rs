...
#[test]
fn test_depth_adversarial_max_u64() {
    let _lock = FAULTKIT_LOCK.lock();
    clear();
    // Test boundaries
    inject(Fault::Mmap {
        fail_after: u64::MAX,
...
#[test]
fn test_depth_adversarial_invalid_floats() {
    let _lock = FAULTKIT_LOCK.lock();
    clear();
...
#[test]
fn test_depth_adversarial_empty_multiple() {
    let _lock = FAULTKIT_LOCK.lock();
    clear();
...
#[test]
fn test_depth_adversarial_massive_multiple() {
    let _lock = FAULTKIT_LOCK.lock();
    clear();
...
#[test]
fn test_depth_adversarial_alternating() {
    let _lock = FAULTKIT_LOCK.lock();
    clear();
...
#[test]
fn test_depth_adversarial_max_bounds() {
    let _lock = FAULTKIT_LOCK.lock();
