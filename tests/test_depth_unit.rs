...
#[test]
fn test_depth_unit_inject_and_clear() {
...
#[test]
fn test_depth_unit_try_inject_and_inject() {
    let _lock = FAULTKIT_LOCK.lock();
    clear();
...
#[test]
fn test_depth_unit_should_fail_all_types() {
    let _lock = FAULTKIT_LOCK.lock();
    clear();
...
#[test]
fn test_depth_unit_duplicate_fail_point() {
    let _lock = FAULTKIT_LOCK.lock();
    clear();
...
#[test]
fn test_depth_unit_inject_scoped() {
    let _lock = FAULTKIT_LOCK.lock();
    clear();
    {
...
#[test]
fn test_depth_unit_cleared_faults_struct() {
    let _lock = FAULTKIT_LOCK.lock();
    clear();
